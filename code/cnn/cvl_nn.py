...
class CVLNeuralNetwork(NeuralNetwork):
    ...
    def _init_w_b(self):
        ...
        w0 = np.asarray([[[3710.669733], [4652.961025], [1095.952073]],
                        [[4321.051033], [4428.459554], [1973.079748]],
                        [[6070.385994], [5199.325586], [4024.355601]]])

        b0 = np.asarray([[[0.481016], [1.479405], [1.644163], [1.664827], [2.603248], [-0.692180], [-22.570521], [5.984156], [-7.046535], [1.147998], [-6.040013], [1.435000], [1.840228], [1.881080], [1.723612], [2.414390], [1.436876], [0.501127]],
        ...
        w1 = np.asarray([[[0.783723], [0.313253], [-0.078143]],
                        [[0.051495], [0.091621], [0.300788]],
                        [[0.521301], [0.720201], [0.216941]]])

        b1 = np.asarray([[[1.672836], [1.679473], [1.695475], [1.676572], [1.669898], [-1.474858], [-2.073087], [-1.474858], [-1.474858], [-0.685062], [1.667057], [1.664220], [1.710309], [1.678113], [1.685421], [1.687634]],
